import { Plus, X, Trash } from "phosphor-react";
...
export function Header() {
  return (
    <div className="w-full max-w-3xl mx-auto flex items-center justify-between headerMobile">
      ...
      <Dialog.Root>
        <Dialog.Trigger
          ...
          newHabbitButton"
        >
          <Plus size={20} className="text-violet-500 newHabbitPlus" />
          Novo hábito
        </Dialog.Trigger>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="absolute p-10 bg-zinc-900 rounded-2xl w-full max-w-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 newHabitFormMobile">
      ...
      <Dialog.Root>
        <Dialog.Trigger
          ...
          newHabbitButton"
        >
          <Trash size={20} className="text-violet-500 deleteHabitTrash" />
          Excluir hábito
        </Dialog.Trigger>
